/**
 * SphereController — owns the whole 3D "packed sphere" subsystem, extracted from app.ts.
 *
 ...
 *
 * Compositing "A": Three renders to its own off-DOM canvas, drawn as a Pixi texture sprite
