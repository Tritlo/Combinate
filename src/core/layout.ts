 ...
 * standalone picture (expanded S visibly contains expanded K turned a quarter-turn) — see 
 * (and  for the 3D H-tree's signed cousin of this cycle). The arm length shrinks
