/**
 * The 3D "packed sphere" view () — a lazy Three.js renderer for the focused term. A
 ...
 * later (). The 2D Pixi scene is untouched — this is a parallel canvas the toggle covers
 * it with.
 */
...
export class Sphere3D {
  ...
  private makeRenderer(three: typeof T): T.WebGLRenderer {
    // WebGL today ( — WebGPU is a later renderer-factory branch). Antialiased, DPR-capped.
