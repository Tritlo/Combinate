...
>
> **Scott-world update ( + 0006).** This doc was written against a Church
> encoding and went stale after the switch to **Scott** data ( — the
...
> authoring verbs (U2) have since **shipped** as one-hole Define/Abstract (
