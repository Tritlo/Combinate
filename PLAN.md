...
*stock* dump instead of forking MicroHs** (, *Revised decision*). That
...
> **Obsolete (2026-06-26).** The post-process approach ( *Revised decision*)
...
### B3 — MicroHs integration () — ✅ shipped (post-process approach)
