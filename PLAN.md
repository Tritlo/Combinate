...
### B1 — Golf, leaderboards, sonification ()
...
### B2 — Authoring: Define, then one-hole Abstract ()
...
### B3 — MicroHs integration () — TS side
...
1. Merge `roadmap` ( + `CONTEXT.md` + this PLAN) → `main`, so every
