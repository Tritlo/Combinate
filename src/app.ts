...
export async function mountApp(): Promise<void> {
  ...
  // ---- type lens (): an opt-in badge appending the focused term's
  ...
  // The read-as mode is just the current hotbar page (): a typed page
  ...
  // Haskell → ι panel (): compile a primitive-free program and drop the
