...
export async function mountApp(onStep: (label: string) => void = () => {}): Promise<void> {
  ...
  // ---- controls (): keyboard/controller play via a bucket tray + hand, always live in 2D.
  ...
  window.addEventListener("keydown", (e) => {
    ...
    // INSPECT (3D) OWNS the keyboard (): its bound keys act and every desktop letter-shortcut
